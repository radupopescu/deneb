...
#[derive(Debug, Fail)]
pub enum DenebError {
    #[fail(display = "Disk IO error")] DiskIO,
    #[fail(display = "Command line parameter parsing error: {}", _0)] CommandLineParameter(String),
    #[fail(display = "Directory visit error: {:?}", _0)] DirectoryVisit(PathBuf),
    #[fail(display = "Invalid path encountered: {:?}", _0)] InvalidPath(PathBuf),
    #[fail(display = "Index generator error")] IndexGenerator,
    #[fail(display = "Digest read error")] DigestFromSlice,
}
...
#[derive(Debug, Fail)]
pub enum StoreError {
    #[fail(display = "Get error for: {}", _0)] ChunkGet(String),
    #[fail(display = "Put error for: {}", _0)] ChunkPut(String),
}
...
pub enum CatalogError {
    #[fail(display = "INode serialization error for index: {}", _0)] INodeSerialization(u64),
    #[fail(display = "Dir entry serialization error for index: {}", _0)] DEntrySerialization(u64),
    #[fail(display = "INode deserialization error for index: {}", _0)] INodeDeserialization(u64),
    #[fail(display = "Dir entry deserialization error for index: {}", _0)]
    DEntryDeserialization(u64),
    #[fail(display = "INode read error for index: {}", _0)] INodeRead(u64),
    #[fail(display = "INode write error for index: {}", _0)] INodeWrite(u64),
    #[fail(display = "Dir entry read error for index: {}", _0)] DEntryRead(u64),
    #[fail(display = "Dir entry write error for index: {}", _0)] DEntryWrite(u64),
